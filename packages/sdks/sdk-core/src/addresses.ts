...
export const V2_FACTORY_ADDRESSES: AddressMap = {
  ...
  [ChainId.CUSTOM]: Env.V2_FACTORY_ADDRESS,
}
/**
...
export const V2_ROUTER_ADDRESSES: AddressMap = {
  ...
  [ChainId.CUSTOM]: Env.V2_ROUTER_ADDRESS,
}

// Networks that share most of the same addresses i.e. Mainnet, Goerli, Optimism, Arbitrum, Polygon
const DEFAULT_ADDRESSES: ChainAddresses = {
  v3CoreFactoryAddress: Env.V3_FACTORY_ADDRESS,
  multicallAddress: Env.MULTICALL_ADDRESS,
  quoterAddress: Env.QUOTER_V2_ADDRESS,
  nonfungiblePositionManagerAddress: Env.NONFUNGIBLE_POSITION_MANAGER_ADDRESS,
  tickLensAddress: Env.TICK_LENS_ADDRESS,
  mixedRouteQuoterV1Address: Env.MIXED_ROUTE_QUOTER_V1_ADDRESS,
}
...
const CUSTOM_CHAIN_ADDRESSES: ChainAddresses = {
  v3CoreFactoryAddress: Env.V3_FACTORY_ADDRESS,
  multicallAddress: Env.MULTICALL_ADDRESS,
  quoterAddress: Env.QUOTER_V2_ADDRESS,
  nonfungiblePositionManagerAddress: Env.NONFUNGIBLE_POSITION_MANAGER_ADDRESS,
...
export const CHAIN_TO_ADDRESSES_MAP: Record<SupportedChainsType, ChainAddresses> = {
  ...
  [ChainId.CUSTOM]: CUSTOM_CHAIN_ADDRESSES,
}
