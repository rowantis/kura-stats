import { BigintIsh, CurrencyAmount, Price, Token } from '@newdex/sdk-core'
import JSBI from 'jsbi'
import invariant from 'tiny-invariant'
import { FACTORY_DEPLOYER_ADDRESS, FeeAmount, TICK_SPACINGS } from '../constants'
...
export class Pool {
  ...
  public static getAddress(
    ...
    return computePoolAddress({
      ...
      factoryAddress: FACTORY_DEPLOYER_ADDRESS,
      fee,
      tokenA,
      tokenB,
