...
import { ChainId, computeZksyncCreate2Address, Token } from '@newdex/sdk-core'
import { FeeAmount, poolInitCodeHash, TICK_SPACINGS } from '../constants'
...
export function computePoolAddress({
  ...
  const salt = keccak256(
    ...
    [defaultAbiCoder.encode(['address', 'address', 'uint24'], [token0.address, token1.address, tickSpacing])] 
  )
